...
{
    public class SlopeScene : BlockSceneBase
    {
        public SlopeScene(GridPos gridPosition, int yaw, BlockType type, bool isGhost)
            : base(gridPosition, yaw, type, isGhost)
        {
            var renderer = BlockRendererFactory.GetRenderer(BlockShape.Slope);
