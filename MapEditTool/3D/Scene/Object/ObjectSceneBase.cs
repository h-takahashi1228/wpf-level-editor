...
{
    public abstract class ObjectSceneBase
    {
        ...
        protected ObjectSceneBase(GridPos gridPosition, int yaw, bool isGhost, bool canPlace)
        {
        ...
        // Sceneの更新
        public virtual void Update(GridPos pos, int yaw, bool isGhost, bool canPlace)
        {
            GridPosition = pos;
            Yaw = yaw;
            IsGhost = isGhost;
